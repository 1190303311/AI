...
class BERT_LSTM_CRF(nn.Module):
    ...
    def forward(self, sentence, attention_mask=None):
        '''
        :param sentence:(batch_size, seq_len(300))
        :param attention_mask:(batch_size, 300)
        :return: crf output(word_seq_len, batch_size, tag_size, tag_size),hidden
        '''
        ...
        lstm_feats = l_out.contiguous().view(batch_size, seq_len, -1)
        return lstm_feats
